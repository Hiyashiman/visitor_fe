          ...
          child: Column(
            ...
            children: [
              ...
              if (_data != null) ...[
                ...
                if (_data!.cid != null) DisplayInfo(title: 'เลขบัตรประชาชน', value: _data!.cid!),
                ...
                if (_data!.gender != null)
                  DisplayInfo(title: 'เพศ', value: '(${_data!.gender}) ${_data!.gender == 1 ? 'ชาย' : 'หญิง'}'),
                if (_data!.birthdate != null)
                  DisplayInfo(
                      title: 'วันเดือนปีเกิด',
                      value: '${_data!.birthdate.toString()}\n${formattedDate(_data!.birthdate)}'),
                if (_data!.address != null) DisplayInfo(title: 'ที่อยู่', value: _data!.address!),
                if (_data!.issueDate != null)
                  DisplayInfo(
                      title: 'วันออกบัตร', value: '${_data!.issueDate.toString()}\n${formattedDate(_data!.issueDate)}'),
  ...
  Widget build(BuildContext context) {
    ...
    _copyFn(value) {
      Clipboard.setData(ClipboardData(text: value)).then((_) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Copy it already")));
      });
    }
